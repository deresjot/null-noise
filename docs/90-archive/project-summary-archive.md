...
- [docs/reference-goals.md](../10-principles/reference-goals.md)
...
- [docs/a11y-principles.md](../10-principles/a11y-principles.md)
- [docs/a11y-testing.md](../20-testing/a11y-testing.md)
- [docs/ux-principles.md](../10-principles/ux-principles.md)
- [docs/product-principles.md](../10-principles/product-principles.md)
- [docs/reference-goals.md](../10-principles/reference-goals.md)
...
Die dokumentierte Strategie dazu liegt in [docs/ui-component-strategy.md](../30-architecture/ui-component-strategy.md).
...
- mobile Home-Einstiege nach Priorität beruhigt: Suche bleibt primär, Richtungsstart bleibt sekundär, ohne neue Produktlogik
- die Ersteinschätzung nutzt intern ein kleines Evidence-Modell: TMDb ist die aktive Basisquelle, Does the Dog Die und Common Sense Media sind nur optionale Noop-Adapter ohne Keys
- sichtbar bleiben kurze Gründe und Vorläufigkeit, aber keine Scores, Prozentwerte oder Rankings
- das Evidence-Modell wurde mit lokalen Beispielprofilen kalibriert und unterscheidet intern sensorische, visuelle und emotionale Intensität genauer; TMDb bleibt die einzige aktive Quelle
...
- keine aktivierten externen Trigger-/Medienbewertungsquellen ohne geklärten Zugriff, Nutzungsbedingungen, API-Key und Speicherentscheidung
