...
- Release-Kandidat 5. Juli 2026: Version und sichtbarer Footer-/Changelog-Stand sind auf `0.8.5-beta-ui-hardening.20260705` synchronisiert. Lint, Production-Build, 99 Unit-Tests mit separater Testdatenbank, 6 direkte axe-core-Tests, 66 A11y-Tests, die technische WCAG-2.2-AA-Matrix (5 bestanden, 1 explorativer AAA-Test planmäßig übersprungen) und `git diff --check` sind grün.
